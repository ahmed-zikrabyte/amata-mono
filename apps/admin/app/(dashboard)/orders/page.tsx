...
//   items: IOrderItem[];
//   totalAmount: number;
//   paymentMethod: "razorpay" | "cod" | "stripe" | string; // extendable
//   createdAt: string | Date; // API may return string; convert to Date if needed
//   __v?: number;
// }
...
//       header: "Phone",
//       cell: ({ row }) => {
//         return <div>{row.original.address?.phoneNumber || "N/A"}</div>;
//       },
//     },
//     {
