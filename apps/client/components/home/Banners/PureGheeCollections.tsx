            ...
            <div className="w-full max-w-7xl mx-auto">
              ...
              {loading ? (
                ...
                <Carousel opts={{ align: "start", loop: true }} className="w-full">
                  ...
                  {/* Custom Arrows */}
                  <CarouselPrevious className="ml-6 border border-red-600 text-red-600 bg-white hover:bg-red-100 transition" />
                  <CarouselNext className="mr-6 bg-red-600 text-white hover:bg-red-700 transition" />
                </Carousel>
              ) : (
