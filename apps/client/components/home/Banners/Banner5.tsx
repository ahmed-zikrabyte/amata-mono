            ...
            <div className="w-full max-w-7xl mx-auto">
              ...
              {loading ? (
                ...
                <Carousel opts={{ align: "start", loop: true }} className="w-full">
                  ...
                  {/* Custom Arrows */}
                  <CarouselPrevious className="ml-8 border border-primary text-primary bg-white hover:bg-red-100 transition" />
                  <CarouselNext className="mr-8 bg-primary text-white hover:bg-primary/70 hover:text-white transition" />
                </Carousel>
              ) : (
