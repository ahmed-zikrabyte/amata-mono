              ...
              <div>
                ...
                <ul className="mt-6 space-y-4 text-sm sm:text-base text-[#4B2C20] leading-relaxed">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 mt-2 bg-[#4B2C20] rounded-full flex-shrink-0"></span>
                    <span>
                      <strong>Farm-to-Home Transparency</strong> – Ghee made on
                      our own ethical farms
                    </span>
                  </li>
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4 text-sm sm:text-base text-[#4B2C20] leading-relaxed">
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 mt-2 bg-[#4B2C20] rounded-full flex-shrink-0"></span>
                    <span>
                      <strong>Ethically Raised Cows</strong> – Free-grazing, hormone-free
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 mt-2 bg-[#4B2C20] rounded-full flex-shrink-0"></span>
                    <span>
                      <strong>Traditional Bilona Process</strong> – Retains maximum nutrition.
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 mt-2 bg-[#4B2C20] rounded-full flex-shrink-0"></span>
                    <span>
                      <strong>Small Batch Production</strong> – Ensures qulity and freshness.
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 mt-2 bg-[#4B2C20] rounded-full flex-shrink-0"></span>
                    <span>
                      <strong>Lab Tested Purity</strong> –  Every batch certifed by NABL labs
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 mt-2 bg-[#4B2C20] rounded-full flex-shrink-0"></span>
                    <span>
                      <strong>Farm-to-Home Trasparency</strong> – We Know every cow, every btach.                      Ghee).
                    </span>
                  </li>
                </ul>
              </div>
