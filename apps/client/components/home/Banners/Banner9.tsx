                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-white text-sm sm:text-base leading-relaxed sm:leading-loose">
                      ...
                      starts much before my name was ever on a label. I was born
                      in Jamadoba, Dhanbad, Jharkhand, into a family that valued
                      ...
                      taste, freshness, and the wholesome goodness he had grown
                      up with. Ghee available in markets had no aroma, no grainy
                      texture, and no assurance of purity. And my father knew –
                      food is not just food, it's the foundation of health.
                    </p>
